...
_If this feature will require breaking changes to any APIs, outline what those are and why they are needed. What is the path to minimizing impact? (example, add new API and deprecate the old one)_
