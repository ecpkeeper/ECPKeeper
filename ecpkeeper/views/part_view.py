...
class PartView(tk.Frame):
    ...
    def __init__(self, parent, data, callbacks, edit, **kwargs):
        ...
        if edit is not True:
            self.fields['initial_stock_level_spinbox'] = tk.Spinbox(self, from_=0, to=10000000000000)
            self.fields['stock_user'] = tk.Entry(self)
            self.fields['price_spinbox'] = tk.Spinbox(self, from_=0, to=10000000000000)
            self.fields['price_checkbutton'] = tk.Checkbutton(self, text="Per Item", variable=self.price_per_item,
                                                              onvalue=1, offvalue=0)
        ...
        if edit is not True:
            self.initial_stock_level_lbl.grid(column=0, row=11, sticky='w', padx=5, pady=5)
            self.stock_user_lbl.grid(column=5, row=11, sticky='w', padx=5, pady=5)
            self.price_lbl.grid(column=0, row=12, sticky='w', padx=5, pady=5)
        ...
        self.fields['comment'].grid(column=1, row=6, columnspan=10, padx=5, pady=5, sticky='nswe')
        ...
        if edit is not True:
            self.fields['initial_stock_level_spinbox'].grid(column=1, row=11, columnspan=4, padx=5, pady=5, sticky='we')
            self.fields['stock_user'].grid(column=6, row=11, columnspan=5, padx=5, pady=5, sticky='we')
            self.fields['price_spinbox'].grid(column=1, row=12, columnspan=9, padx=5, pady=5, sticky='we')
            self.fields['price_checkbutton'].grid(column=10, row=12, columnspan=1, padx=5, pady=5, sticky='we')
    ...
    def get(self):
        ...
        if self.edit is not True:
            initial_stock_level_spinbox = self.fields['initial_stock_level_spinbox'].get()
